...
def hello():
    image1 = Image.open("image\\AI_py4.png")
...
def weather(text):
    ...
    if "rain" in text:
        image1 = Image.open("image\\AI_rain.png")
        image_1 = ImageTk.PhotoImage(image1)    
        label1 = Label(image=image_1)
        label1.image = image_1
        label1.place(x=7, y=43)
    else :
        image1 = Image.open("image\\AI_sunny.png")
        image_1 = ImageTk.PhotoImage(image1)    
        label1 = Label(image=image_1)
        label1.image = image_1
        label1.place(x=7, y=43)
...
def get_math():
    ...
    root.update()
    image_1 = ImageTk.PhotoImage(Image.open("image\\AI_math.png"))    
    label1 = Label(image=image_1)
    label1.image = image_1
    label1.place(x=7, y=43)
...
class Example(Frame):
    ...
    def initUI(self):
        ...
        image3 = Image.open("image\\AI_micro.png")
        ...
        image_1 = ImageTk.PhotoImage(Image.open("image\\AI_py2.png"))    
